    ...
    <body>
        <div class="container">
            ...
            <div class="d-flex">
                ...
                <span class="dropdown">
                    <button class="btn btn-light dropdown-toggle btn-sm" type="button" id="dropdown2" data-bs-toggle="dropdown" aria-expanded="false">
                        <-- ทั้งหมด -->
                            <ul class="dropdown-menu" aria-labelledby="dropdown2">
                                <li><a href="" class="dropdown-item">ทั้งหมด</a></li>
                                <li><a href="" class="dropdown-item">เรื่องเรียน</a></li>
                                <li><a href="" class="dropdown-item">เรื่อวทั่วไป</a></li>
                            </ul>
                    </button>
                </span>
            </div>
        ...
        <div class="container">
            ...
            <div>
                ...
                <table class="table table-striped">
                    <?php
                    for ($i = 1; $i <= 10; $i++) {
                        echo "<tr><td><a href=post.php?id=$i style=text-decoreation:none>กระทู้ที่ $i</a></td>";
                        if ($_SESSION['role'] == 'a') {
